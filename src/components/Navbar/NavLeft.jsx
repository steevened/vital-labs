  ...
  return (
    <div>
      <div
        ...
        className={`absolute top-0 backdrop-blur-[2px] left-0 w-full h-full transition-all bg-black/50 z-10 ${
          isToolbarOpen ? 'opacity-100' : 'opacity-0 pointer-events-none -z-10'
        }}`}
      ></div>
      <div
        className={`shadow-lg shadow-black/30 absolute transition-all left-0 top-0 bottom-0 w-60 bg-base-200 z-20 ${
      ...
      >
        ...
        <div className="w-full border ">
          <div className="w-5/6 mx-auto mt-10">
            <button className="btn btn-block flex gap-2">
              <div>
                <svg
          ...
          <ul className="border flex flex-col h-full items-start justify-start w-5/6 mx-auto gap-5">
            <li className="w-full">
              <button className="btn btn-block btn-primary flex gap-2">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
