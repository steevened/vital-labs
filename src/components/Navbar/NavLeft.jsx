...
const NavLeft = ({ collapsed, setCollapsed }) => {
  ...
  return (
    <div
      className={`shadow-lg fixed top-0 bottom-0 shadow-black/30 md:translate-x-0 transition-all  w-60 bg-gradient-to-b from-p-primary to-p-to z-20 ${
    ...
    >
      ...
      <ul className=" flex flex-col h-full items-start justify-start w-5/6 mt-10 gap-5">
        <li
          onClick={(e) => {
            navigate('/');
            closeToolbar();
